      ...
      <view class="drawer-content">
        <van-cell-group>
          ...
          <van-cell
            ...
            @click="openSheet('finishStatusOptions')"
          />
          <van-cell
            title-width="100px"
            title="创建时间-起"
...
export default {
  ...
  methods: {
    ...
    onSheetSelect({ detail }) {
      ...
      if (this.sheetChecked === "finishStatusOptions") {
        this.checkedFinishStatusName = detail.name;
        this.searchData.finish_status = detail.value;
      }
    },
    // 选择业绩归属人
